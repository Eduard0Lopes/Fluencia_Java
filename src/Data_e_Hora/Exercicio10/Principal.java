...
public class Principal {
    ...
    // de entrada e saída dos funcionários. O sistema deve calcular o horário de saída com base na hora de entrada
    // e na carga horária diária.
    //
    ...
    // permitindo que ele informe os horários diretamente. Neste caso, primeiro, crie um objeto Scanner para ler os
    // dados digitados. Depois, defina um DateTimeFormatter para garantir que os horários sejam inseridos no formato
    // correto, ou seja, com duas casas para horas e minutos, separados por dois pontos (HH:mm), como "08:05".
    // Isso evita erros ao converter o valor digitado em um objeto LocalTime. Em seguida, solicite a entrada do
    // usuário com System.out.print() e utilize LocalTime.parse() para interpretar a string informada e transformá-la
    // em um horário válido.
