...
//
// acordo com o fuso horário, você precisa de um sistema que converta automaticamente o horário local para o horário
//
// de Sydney.
//
//Crie um programa que converta o horário atual do sistema (fuso horário padrão) para o fuso horário de Sydney
//
// (Australia/Sydney) e exiba apenas as horas e os minutos. Dica: Utilize o metodo withZoneSameInstant() para realizar
//
//  a conversão.
